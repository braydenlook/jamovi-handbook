...
![Settings for computing effect size](images/power9-settings.png){.lightbox width=50%}

Your output should look like the following:

![Calculating effect size for power $= 0.7$, $n = 20$](images/power9.png){.lightbox width=75%}
