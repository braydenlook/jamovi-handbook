...
2a. (If you're using jamovi Desktop) Click 'Open' --> 'Browse'
2b. (If you're using jamovi Cloud) Click 'Open' --> 'This Device'
3. This will bring up a file explorer window. Locate the **wingspan.csv** file you just downloaded and click 'Open'.
