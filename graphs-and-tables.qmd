...
![Click on the plots dropdown menu](images/wingspan-plots1.png){width=100% fig-alt="alt text to be replaced"}
...
![Creating boxplots](images/wingspan-boxplot2.png){width=100% fig-alt="alt text to be replaced"}
