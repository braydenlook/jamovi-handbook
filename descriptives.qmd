...
We can add or remove a number of statistics from this menu. Most of them we can ignore, but let's add the quartiles to our summary. This can be done by going to the **Percentile Values** headings and checking the 'Percentiles' box. By default, the values for the 'Percentiles' box should be '$25,50,75$'; if they aren't set to this, change them and then check the box. You should now have the 1st, 2nd, and 3rd quartiles in your descriptive statistics table:

![Adding quartiles to our table](images/wingspan-descriptives5.png){width=100% fig-alt="alt text to be replaced"}
...
![Adding **Region** to the 'Split by' window](images/wingspan-descriptives6.png){width=100% fig-alt="alt text to be replaced"}
